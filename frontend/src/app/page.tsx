...
import { STATS, literaryPlaces } from '@/lib/data';
...
const features = [
  {
    ...
    description:
      'Find literature by meaning, not just keywords. Search "monsoon streets with longing" and discover fiction you never knew existed.',
  },
  {
    icon: Layers,
  ...
  },
  {
    ...
    description:
      'Trace the arc connections between cities an author inhabits across their body of work. See literary worlds as connected graphs.',
  },
  {
    icon: Brain,
    title: 'NLP Pipeline',
    description:
      'spaCy NER, Mordecai geoparsing, LLM-powered structured extraction. From raw text to geocoded literary metadata at scale.',
  },
  {
    icon: Globe2,
    title: 'Historical Gazetteers',
    description:
      'Bombay resolves to Mumbai with temporal metadata. GeoNames, Wikidata, and World Historical Gazetteer for period-accurate mapping.',
  },
  {
    icon: Compass,
    title: 'Sentiment Geography',
    description:
      'How do authors emotionally render cities? See the West End glow with happiness while the East End dims with Dickensian dread.',
  },
];

const featuredPassages = [
  literaryPlaces[0],  // Midnight's Children - Bombay
  literaryPlaces[4],  // God of Small Things - Ayemenem
  literaryPlaces[21], // Ulysses - Dublin
  literaryPlaces[22], // Crime and Punishment - St. Petersburg
  literaryPlaces[28], // One Hundred Years - Macondo
  literaryPlaces[17], // Toba Tek Singh
];
    ...
    <div className="min-h-screen bg-akhand-bg gradient-bg">
      ...
      <nav className="fixed top-0 w-full z-50 glass">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-serif text-lg font-semibold text-akhand-text-primary">
              Akhand
            </span>
          </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            Extracting place references from world literature, geocoding them,
            and rendering them as interactive, searchable, and artistically
            compelling maps. NLP pipelines meet literary cartography.
          </motion.p>
          ...
          >
            {[
              { value: STATS.books, label: 'Novels Mapped' },
              { value: STATS.cities, label: 'Literary Places' },
      ...
      <section className="py-32 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              From NER fine-tuning to historical gazetteer resolution, knowledge
              graphs to WebGL visualization — a convergent stack of NLP,
              spatial databases, and immersive rendering.
            </motion.p>
          </motion.div>
                ...
                <div className="p-6">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <p className="font-serif text-sm italic text-akhand-literary leading-relaxed">
                      &ldquo;{place.passage.length > 180
      ...
      <footer className="border-t border-akhand-border/30 py-12 px-6">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <p className="text-xs text-akhand-text-muted">
            PostGIS + pgvector + Neo4j + deck.gl + spaCy
          </p>
        </div>
      </footer>
    </div>
